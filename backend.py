...
from keras.layers import Activation, Conv2D, Input, MaxPooling2D, BatchNormalization, Lambda
...
class FullYoloFeature(BaseFeatureExtractor):
    ...
    def __init__(self, input_size):
        ...
        self.feature_extractor.load_weights(BACKEND_PATH, by_name=True)
...
class Inception3Feature(BaseFeatureExtractor):
    ...
    def __init__(self, input_size):
        ...
        inception.load_weights(BACKEND_PATH)
...
class VGG16Feature(BaseFeatureExtractor):
    ...
    def __init__(self, input_size):
        ...
        # vgg16.load_weights(BACKEND_PATH)
...
class ResNet50Feature(BaseFeatureExtractor):
    ...
    def __init__(self, input_size):
        ...
        # resnet50.load_weights(BACKEND_PATH)
